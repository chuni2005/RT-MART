 ...
 * 輪播圖橫幅組件，支援自動播放和手動切換
 *
 * @param banners - 輪播圖資料陣列
 * @param autoPlayInterval - 自動播放間隔（毫秒），預設 4000ms
 * @param height - 輪播圖高度（桌面版），預設 400px
 */
const Hero = ({ banners = [], autoPlayInterval = 4000, height = 400 }: HeroProps) => {
