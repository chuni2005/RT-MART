...
export async function createProductTypeWithParentTypeIdAndAdminRole(
...
export async function createProductTypeWithNonExistentParentTypeIdAndAdminRole(
  app: INestApplication,
) {
...
export async function createProductTypeWithNonPermissionRole(
  app: INestApplication,
) {
  await request(app.getHttpServer())
    .post(`/product-types`)
