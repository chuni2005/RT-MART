...
export async function updateNonOwnStoreDataWithNonCookie(app: INestApplication){
...
export async function updateStoreDataWithNonPermissionRole(app: INestApplication){
    await request(app.getHttpServer())
        .patch(`/stores`)
